...
export function setVariablesOutOfEnvironmentString(content) {
...
export function setEnvironments(filePaths) {
...
export function saveEnvironmentsInFile(filePath, data) {
    try {
