...
exports.prepareArrayContains = exports.prepareBetween = exports.prepareLike = exports.prepareSorting = exports.preparePagination = exports.getPaginationObject = void 0;
...
function prepareArrayContains(value) {
    if (!value)
        return;
    return (0, typeorm_1.ArrayContains)([value]);
}
exports.prepareArrayContains = prepareArrayContains;
